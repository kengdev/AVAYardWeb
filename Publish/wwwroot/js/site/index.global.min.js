...
var FullCalendar = (function (e) {
        ...
        for (n.__k = [], h = 0; h < t.length; h++)
            if (
                ...
                O(e, g, (p = p || d), i, s, o, l, a, c),
                    ...
                    null != y
                        ? (null == b && (b = y), "function" == typeof g.type && g.__k === p.__k ? (g.__d = a = _(g, a, e)) : (a = M(e, g, p, E, y, a)), "function" == typeof n.type && (n.__d = a))
            ...
            e: if ("function" == typeof _) {
                if (
                    ...
                    r.__c
                        ...
                        : ("prototype" in _ && _.prototype.render ? (t.__c = u = new _(b, E)) : ((t.__c = u = new C(b, E)), (u.constructor = _), (u.render = B)),
                          S && S.sub(u),
                          (u.props = b),
                          u.state || (u.state = {}),
                          (u.context = E),
                    ...
                    if (
                        (null == _.getDerivedStateFromProps && b !== p && null != u.componentWillReceiveProps && u.componentWillReceiveProps(b, E),
    ...
    function P(e, n, r, i, s, o, l, a) {
        ...
        if (null === m) f === g || (a && e.data === g) || (e.data = g);
            ...
            a ||
                ("value" in g && void 0 !== (v = g.value) && (v !== e.value || ("progress" === m && !v) || ("option" === m && v !== f.value)) && b(e, "value", v, f.value, !1),
    ...
    class zn {
        ...
        createMarkerMeta(e) {
            ...
            let t = null;
            return (
                "number" == typeof e ? (t = this.timestampToMarker(e)) : e instanceof Date ? ((e = e.valueOf()), isNaN(e) || (t = this.timestampToMarker(e))) : Array.isArray(e) && (t = Lt(e)),
    ...
    class ms {
        ...
        splitEntry(e, t, n) {
            ...
            return (
                ...
                r ? (n.push({ index: e.index, thickness: e.thickness, span: Ss(o, s) }, ...i), r) : (n.push(e), 0)
            );
        }
        insertEntryAt(e, t) {
        ...
        render() {
            ...
            return g(
                rr,
                {
                    elTag: "th",
                    elClasses: a,
                    elAttrs: Object.assign({ role: "columnheader", colSpan: i.colSpan, "data-date": l.isDisabled ? void 0 : Ft(s) }, i.extraDataAttrs),
                    renderProps: u,
    ...
    function to(e, t, n, r) {
        ...
        return "function" == typeof t.content
            ...
            : g(
                  ...
                  n.tableColGroupNode,
                  g(r ? "thead" : "tbody", { role: "presentation" }, "function" == typeof t.rowContent ? t.rowContent(n) : t.rowContent)
              );
    }
    function no(e, t) {
        return Dt(e, t, kn);
        ...
        renderChunkTd(e, t, n, r) {
            ...
            return g(
                ...
                g(
                    ...
                    g(Xs, { ref: this.scrollerRefs.createRef(u), elRef: this.scrollerElRefs.createRef(u), overflowY: d, overflowX: i.liquid ? "hidden" : "visible", maxHeight: e.maxHeight, liquid: c, liquidIsAbsolute: !0 }, h)
                )
            );
        }
    ...
    function go(e) {
        return g(
            ...
            g("div", { className: "fc-event-title-container" }, g("div", { className: "fc-event-title fc-sticky" }, e.event.title || g(v, null, " ")))
        );
    }
    const mo = (e) =>
            ...
            return (function (e, t) {
                ...
                g(
                    ...
                    g(
                        ...
                        g("span", { className: "fc-popover-close " + e.getIconClass("close"), title: t.closeHint, onClick: this.handleCloseClick })
                    ),
            ...
            for (let s of e) {
                ...
                if ("title" === e) (i = !1), r.push(g("h2", { className: "fc-toolbar-title", id: t.titleId }, t.title));
                    ...
                    i && d.push(n.getClass("buttonActive")),
                        r.push(g("button", { type: "button", title: "function" == typeof c ? c(t.navUnit) : c, disabled: s, "aria-pressed": i, className: d.join(" "), onClick: o }, l || (a ? g("span", { className: a }) : "")));
                }
            }
            if (r.length > 1) {
    ...
    class kl extends Xn {
        render() {
            ...
            return (
                ...
                g("div", { className: [r || "", "fc-toolbar", i ? "fc-toolbar-ltr" : ""].join(" ") }, this.renderSection("start", e || []), this.renderSection("center", o || []), this.renderSection("end", t || []))
            );
        }
        renderSection(e, t) {
            let { props: n } = this;
    ...
    class Ml extends Xn {
        ...
        render() {
            ...
            return (
                ...
                g("div", { "aria-labelledby": e.labeledById, ref: this.handleEl, className: r.join(" "), style: { height: i, paddingBottom: s } }, e.children)
            );
        }
        componentDidMount() {
            ...
            super(e),
                ...
                (this.handleDragStart = (e) => {
                    ...
                    e.isTouch ? r !== this.component.props.eventSelection && t.dispatch({ type: "SELECT_EVENT", eventInstanceId: r }) : t.dispatch({ type: "UNSELECT_EVENT" }),
                        this.isDragging && (t.calendarApi.unselect(e), t.emitter.trigger("eventDragStart", { el: this.subjectEl, event: new oi(t, n.def, n.instance), jsEvent: e.origEvent, view: t.viewApi }));
                }),
                ...
                constructor(e) {
                    super(e),
                        ...
                        (this.handleHitUpdate = (e, t, n) => {
                            ...
                            l && ((a = ni(i, r.getCurrentData().eventUiBases, l, r)), (d.mutatedEvents = a), zs(d, e.dateProfile, r) || ((c = !0), (l = null), (a = null), (d.mutatedEvents = null))),
                        ...
                        (this.handleDragEnd = (e) => {
                            ...
                            if ((t.emitter.trigger("eventResizeStop", { el: this.draggingSegEl, event: i, jsEvent: e.origEvent, view: t.viewApi }), this.validMutation)) {
                                ...
                                t.emitter.trigger(
                                    "eventResize",
                                    Object.assign(Object.assign({}, a), { el: this.draggingSegEl, startDelta: this.validMutation.startDelta || ht(0), endDelta: this.validMutation.endDelta || ht(0), jsEvent: e.origEvent, view: t.viewApi })
                                ),
    ...
    class ha extends Xn {
        render() {
            ...
            return g(
                po,
                Object.assign({}, e, { elClasses: ["fc-daygrid-event", "fc-daygrid-block-event", "fc-h-event"], defaultTimeFormat: da, defaultDisplayEventEnd: e.defaultDisplayEventEnd, disableResizing: !e.seg.eventRange.def.allDay })
            );
        }
    }
    class fa extends Xn {
                    ...
                    return g(
                        ...
                        t.map((t) => {
                            ...
                            return g(
                                ...
                                ua(t)
                                    ? g(fa, Object.assign({ seg: t, isDragging: !1, isSelected: r === e.eventSelection, defaultDisplayEventEnd: !1 }, Ei(t, e.todayRange)))
                                    : g(ha, Object.assign({ seg: t, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: r === e.eventSelection, defaultDisplayEventEnd: !1 }, Ei(t, e.todayRange)))
                            );
                        })
                    );
                },
                    ...
                    g(
                        ...
                        !l.isDisabled && (t.showDayNumber || bo(i) || t.forceDayTop)
                            ? g(
                                  ...
                                  g(s, { elTag: "a", elClasses: ["fc-daygrid-day-number", a && "fc-daygrid-month-start"], elAttrs: Object.assign(Object.assign({}, es(e, o)), { id: n.dayNumberId }) })
                              )
                            : t.showDayNumber
                ...
                for (let e = 0; e < n.length; e += 1) {
                    ...
                    for (let r of l) {
                        ...
                        (d += r.levelCoord - c),
                            ...
                            s
                                ? ((d += r.thickness), o && u.push({ seg: wa(i, r.span.start, r.span.end, n), isVisible: !0, isAbsolute: !0, absoluteTop: r.levelCoord, marginTop: 0 }))
                                : o && (u.push({ seg: wa(i, r.span.start, r.span.end, n), isVisible: !0, isAbsolute: !1, absoluteTop: r.levelCoord, marginTop: d }), (d = 0));
                    }
                        ...
                        h.push(
                            g(
                                "div",
                                {
                                    ...
                                    style: { visibility: p ? "" : "hidden", marginTop: m ? "" : e.marginTop, top: m ? e.absoluteTop : "", left: v, right: y },
                                },
                                ua(t)
                                    ? g(fa, Object.assign({ seg: t, isDragging: i, isSelected: f === a, defaultDisplayEventEnd: d }, Ei(t, n)))
                                    : g(ha, Object.assign({ seg: t, isDragging: i, isResizing: s, isDateSelecting: o, isSelected: f === a, defaultDisplayEventEnd: d }, Ei(t, n)))
                            )
                        );
                }
            return h;
    ...
    class Oa extends gs {
        ...
        renderSimpleLayout(e, t) {
            ...
            return (
                ...
                g(sr, { elClasses: ["fc-daygrid"], viewSpec: r.viewSpec }, g(ho, { liquid: !n.isHeightAuto && !n.forPrint, collapsibleWidth: n.forPrint, cols: [], sections: i }))
            );
        }
    ...
    function Ba(e) {
        ...
        return g(Yn.Consumer, null, (n) => {
            ...
            return g(
                ...
                (e) => g("div", { className: "fc-timegrid-slot-label-frame fc-scrollgrid-shrink-frame" }, g(e, { elTag: "div", elClasses: ["fc-timegrid-slot-label-cushion", "fc-scrollgrid-shrink-cushion"] }))
            );
        });
    }
    function ja(e) {
                    ...
                    return n.weekNumbers && "day" === e
                        ? g(Do, { elTag: "th", elClasses: ["fc-timegrid-axis", "fc-scrollgrid-shrink"], elAttrs: { "aria-hidden": !0 }, date: i.start, defaultFormat: za }, (e) =>
                              g(
                                  ...
                                  g(e, { elTag: "a", elClasses: ["fc-timegrid-axis-cushion", "fc-scrollgrid-shrink-cushion", "fc-scrollgrid-sync-inner"], elAttrs: s })
                              )
                          )
                    ...
                    return g(
                        ...
                        (t) =>
                            g(
                                ...
                                g(t, { elTag: "span", elClasses: ["fc-timegrid-axis-cushion", "fc-scrollgrid-shrink-cushion", "fc-scrollgrid-sync-inner"] })
                            )
                    );
                }),
            ...
            return (
                ...
                t &&
                    ...
                    s.push({
                        type: "body",
                        key: "all-day-divider",
                        outerContent: g("tr", { role: "presentation", className: "fc-scrollgrid-section" }, g("td", { className: "fc-timegrid-divider " + r.theme.getClass("tableCellShaded") })),
                    })),
        ...
        renderHScrollLayout(e, t, n, r, i, s, o) {
            ...
            e &&
                ...
                t &&
                    ...
                    h.push({
                        key: "all-day-divider",
                        type: "body",
                        outerContent: g("tr", { role: "presentation", className: "fc-scrollgrid-section" }, g("td", { colSpan: 2, className: "fc-timegrid-divider " + a.theme.getClass("tableCellShaded") })),
                    }));
            ...
            return (
                ...
                g(
                    ...
                    g(l, { liquid: !c.isHeightAuto && !c.forPrint, forPrint: c.forPrint, collapsibleWidth: !1, colGroups: [{ width: "shrink", cols: [{ width: "shrink" }] }, { cols: [{ span: r, minWidth: i }] }], sections: h })
                )
            );
        }
            ...
            return g(
                ...
                b.map((e) => {
                    ...
                    return g(
                        ...
                        g(ic, Object.assign({ seg: o, isDragging: n, isResizing: r, isDateSelecting: i, isSelected: c === h, isShort: b }, Ei(o, f, p)))
                    );
                })
            );
        }
                            ...
                            e.axis &&
                                g(
                                    ...
                                    g(
                                        "div",
                                        { className: "fc-timegrid-col-frame" },
                                        g("div", { className: "fc-timegrid-now-indicator-container" }, "number" == typeof n && g(mo, { elClasses: ["fc-timegrid-now-indicator-arrow"], elStyle: { top: n }, isAxis: !0, date: e.nowDate }))
                                    )
                                ),
                            e.cells.map((t, n) =>
                                g(sc, {
    ...
    class yc extends Xn {
        ...
        render() {
            ...
            return g(
                ...
                (t) => g("th", { scope: "colgroup", colSpan: 3, id: i, "aria-labelledby": l }, g(t, { elTag: "div", elClasses: ["fc-list-day-cushion", e.getClass("tableCellShaded")] }))
            );
        }
    }
    function bc(e) {
        return g(
            ...
            e.sideText && g("a", Object.assign({ "aria-hidden": !0, className: "fc-list-day-side-text" }, e.sideNavLinkAttrs), e.sideText)
        );
    }
                ...
                component: class extends gs {
                    ...
                    render() {
                        ...
                        return g(
                            ...
                            g(Xs, { liquid: !e.isHeightAuto, overflowX: e.isHeightAuto ? "visible" : "hidden", overflowY: e.isHeightAuto ? "visible" : "auto" }, i.length > 0 ? this.renderSegList(i, n) : this.renderEmptyMessage())
                        );
                    }
                    renderEmptyMessage() {
                    ...
                    renderSegList(e, t) {
                        ...
                        return g(Os, { unit: "day" }, (e, a) => {
                            ...
                            return g(
                                ...
                                g("thead", null, g("tr", null, g("th", { scope: "col", id: i }, r.timeHint), g("th", { scope: "col", "aria-hidden": !0 }), g("th", { scope: "col", id: s }, r.eventHint))),
                                g("tbody", null, c)
                            );
                        });
                    }
            ...
            return g(
                ...
                g(
                    ...
                    g(
                        ...
                        g("thead", { role: "rowgroup" }, g(Ps, { dateProfile: e.dateProfile, dates: o.headerDates, datesRepDistinctDays: !1 }))
                    )
                ),
                g(
                    "div",
                ...
                if (!/\w+:\/\/fullcalendar\.io\/|\/examples\/[\w-]+\.html$/.test(n)) {
                    ...
                    if ("valid" !== n)
                        return g(
                            ...
                            "outdated" === n
                                ? g(v, null, "Your license key is too old to work with this version. ", g("a", { href: "https://fullcalendar.io/docs/schedulerLicenseKey#outdated" }, ""))
                                : g(v, null, "", g("a", { href: "https://fullcalendar.io/docs/schedulerLicenseKey#invalid" }, ""))
                        );
                }
                return null;
            },
    ...
    class Yc extends Xn {
        ...
        renderChunk(e, t, n, r, i, s, o, l) {
            ...
            return (
                (D = g(Gc, { ref: this.clippedScrollerRefs.createRef(f), scrollerElRef: this.scrollerElRefs.createRef(f), overflowX: R, overflowY: A, forPrint: this.props.forPrint, liquid: C, maxHeight: e.maxHeight }, D)),
            ...
            o = Array.isArray(s)
                ...
                : (function (e, t, n, r) {
                      ...
                      switch (l) {
                          ...
                          case "hour":
                              a && (c = { week: "short" }),
                                  vd("days", t, n) > 1 && (i = { weekday: "short", day: "numeric", month: "numeric", omitCommas: !0 }),
                          ...
                          case "second":
                              bt(o) / 60 >= 6
                                  ? ((c = { hour: "numeric", minute: "2-digit", meridiem: "lowercase" }), (i = (e) => ":" + st(e.date.second, 2)))
            ...
            return g(
                ...
                (n) =>
                    g(
                        ...
                        g(n, { elTag: "a", elClasses: ["fc-timeline-slot-cushion", "fc-scrollgrid-sync-inner", e.isSticky && "fc-sticky"], elAttrs: this.buildCellNavLinkAttrs(t, i.date, i.rowUnit) })
                    )
            );
        }
    }
            ...
            return g(Os, { unit: n }, (n, i) =>
                g(
                    ...
                    g(
                        ...
                        e.tableColGroupNode,
                        g("tbody", null, g(wd, { dateProfile: e.dateProfile, tDateProfile: e.tDateProfile, nowDate: n, todayRange: i, rowInnerHeights: e.rowInnerHeights }))
                    ),
                    t.options.nowIndicator &&
                        g("div", { className: "fc-timeline-now-indicator-container" }, r && r.isDateInRange(n) && g(mo, { elClasses: ["fc-timeline-now-indicator-arrow"], elStyle: Ad(r.dateToCoord(n), t.isRtl), isAxis: !0, date: n }))
                )
            );
        }
        componentDidMount() {
            ...
            return g(
                rr,
                {
                    ...
                    elClasses: [
                        ...
                        o.isTimeScale ? (at(n.countDurationsBetween(o.normalizedRange.start, e.date, o.labelInterval)) ? "fc-timeline-slot-major" : "fc-timeline-slot-minor") : "",
        ...
        render() {
            ...
            return g(
                ...
                g(
                    ...
                    e.tableColGroupNode,
                    g(kd, { cellElRefs: this.cellElRefs, dateProfile: e.dateProfile, tDateProfile: e.tDateProfile, nowDate: e.nowDate, todayRange: e.todayRange })
                )
            );
        }
        componentDidMount() {
                        ...
                        g(
                            ...
                            n.map((t) => {
                                ...
                                return g(
                                    ...
                                    g(Hd, Object.assign({ isTimeScale: e.isTimeScale, seg: t, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: n === e.eventSelection }, Ei(t, e.todayRange, e.nowDate)))
                                );
                            })
                        ),
                },
    ...
    class Bd extends Xn {
        ...
        updateSize() {
            ...
            e.onHeightChange && e.onHeightChange(n, !1),
                t &&
                    this.setState(
                        { eventInstanceHeights: xn(this.harnessElRefs.currentMap, (e) => Math.round(e.getBoundingClientRect().height)), moreLinkHeights: xn(this.moreElRefs.currentMap, (e) => Math.round(e.getBoundingClientRect().height)) },
                        () => {
        ...
        renderFgSegs(e, t, n, r, i) {
            ...
            return g(
                ...
                e.map((e) => {
                    ...
                    return g(
                        "div",
                        { key: "e:" + f, ref: c ? null : s.createRef(f), className: "fc-timeline-event-harness", style: Object.assign({ visibility: p ? "" : "hidden", top: h || 0 }, m) },
                        g(Hd, Object.assign({ isTimeScale: l.tDateProfile.isTimeScale, seg: d, isDragging: n, isResizing: r, isDateSelecting: i, isSelected: f === l.eventSelection }, Ei(d, l.todayRange, l.nowDate)))
                    );
                })
            );
        }
                ...
                g(Os, { unit: o }, (o, l) =>
                    g(
                        ...
                        r.nowIndicator &&
                            ...
                            g("div", { className: "fc-timeline-now-indicator-container" }, g(mo, { elClasses: ["fc-timeline-now-indicator-line"], elStyle: Ad(t.coords.dateToCoord(o), n.isRtl), isAxis: !1, date: o }))
                    )
                )
            );
        }
                    ...
                    render() {
                        ...
                        return (
                            ...
                            g(
                                ...
                                g(Yc, { ref: this.scrollGridRef, liquid: !e.isHeightAuto && !e.forPrint, forPrint: e.forPrint, collapsibleWidth: !1, colGroups: [{ cols: a }], sections: c })
                            )
                        );
                    }
    ...
    class $d extends Xn {
        render() {
            let { props: e } = this;
            return g(Qd, { elTag: "th", elClasses: ["fc-col-header-cell", "fc-resource"], elAttrs: { role: "columnheader", colSpan: e.colSpan }, resource: e.resource, date: e.date }, (t) =>
                g("div", { className: "fc-scrollgrid-sync-inner" }, g(t, { elTag: "span", elClasses: ["fc-col-header-cell-cushion", e.isSticky && "fc-sticky"] }))
            );
        }
    }
    class Jd extends Xn {
        ...
        renderDateCell(e, t, n, r, i, s) {
            ...
            return o.datesRepDistinctDays
                ? g(ks, { key: e.toISOString() + l, date: e, dateProfile: o.dateProfile, todayRange: n, colCnt: o.dates.length * o.resources.length, dayHeaderFormat: t, colSpan: r, isSticky: s, extraRenderProps: a, extraDataAttrs: c })
                : g(Is, { key: e.getUTCDay() + l, dow: e.getUTCDay(), dayHeaderFormat: t, colSpan: r, isSticky: s, extraRenderProps: a, extraDataAttrs: c });
        }
        buildTr(e, t) {
    ...
    var Ou = zo({
        ...
        isPropsValid: function (e, t) {
            ...
            for (let e in n) {
                let r = n[e];
                if (
                    (e && n[""] && (r = Object.assign(Object.assign({}, r), { eventStore: Nr(n[""].eventStore, r.eventStore), eventUiBases: Object.assign(Object.assign({}, n[""].eventUiBases), r.eventUiBases) })),
    ...
    function Uu({ depth: e, hasChildren: t, isExpanded: n, onExpanderClick: r }) {
        ...
        return (
            ...
            i.push(g("span", { className: "fc-datagrid-expander" + (t ? "" : " fc-datagrid-expander-placeholder"), onClick: r }, g("span", { className: s.join(" ") }))),
            g(v, {}, ...i)
        );
    }
    class Gu extends Xn {
                ...
                (t) =>
                    g(
                        ...
                        g(
                            ...
                            n.isMain && g(Uu, { depth: e.depth, hasChildren: e.hasChildren, isExpanded: e.isExpanded, onExpanderClick: this.onExpanderClick }),
    ...
    class qu extends Xn {
        render() {
            ...
            return g(
                ...
                (e) => g("div", { className: "fc-datagrid-cell-frame fc-datagrid-cell-frame-liquid" }, g(e, { elTag: "div", elClasses: ["fc-datagrid-cell-cushion", "fc-sticky"] }))
            );
        }
    }
    function Yu(e) {
            ...
            return g(
                ...
                e.colSpecs.map((s, o) => {
                    ...
                    return l > 1
                        ...
                        : g(Gu, { key: o, colSpec: s, resource: t, fieldValue: a, depth: r, hasChildren: e.hasChildren, isExpanded: e.isExpanded, innerHeight: e.innerHeight });
                })
            );
        }
    }
                ...
                i.push(
                    g(
                        ...
                        g(
                            ...
                            (e) => g("div", { className: "fc-datagrid-cell-frame", style: { height: s } }, g(e, { elTag: "div", elClasses: ["fc-datagrid-cell-cushion", "fc-scrollgrid-sync-inner"] }))
                        )
                    )
                );
            }
                                ...
                                (e) =>
                                    g(
                                        ...
                                        g(
                                            "div",
                                            { className: "fc-datagrid-cell-cushion fc-scrollgrid-sync-inner" },
                                            t.isMain && g("span", { className: "fc-datagrid-expander fc-datagrid-expander-placeholder" }, g("span", { className: "fc-icon" })),
                ...
                g(Os, { unit: s }, (t, s) =>
                    g(
                        ...
                        n.options.nowIndicator &&
                            d &&
                            d.isDateInRange(t) &&
                            g("div", { className: "fc-timeline-now-indicator-container" }, g(mo, { elClasses: ["fc-timeline-now-indicator-line"], elStyle: Ad(d.dateToCoord(t), n.isRtl), isAxis: !1, date: t }))
                    )
                )
            );
        }
    ...
    class sh extends Xn {
        ...
        renderSpreadsheetRows(e, t, n) {
            return e.map((e, r) =>
                e.group
                    ? g(Zu, { key: e.id, id: e.id, spreadsheetColCnt: t.length, isExpanded: e.isExpanded, group: e.group, innerHeight: n[r] || "" })
                    : e.resource
                    ? g(Qu, { key: e.id, colSpecs: t, rowSpans: e.rowSpans, depth: e.depth, isExpanded: e.isExpanded, hasChildren: e.hasChildren, resource: e.resource, innerHeight: n[r] || "" })
                    : null
            );
        }
        componentDidMount() {
                            ...
                            Gn(() => {
                                j(
                                    g(
                                        ...
                                        (t, n, r, i) => (this.setClassNames(t), this.setHeight(n), g(nr.Provider, { value: this.customContentRenderId }, g(Nl, Object.assign({ isHeightAuto: r, forPrint: i }, e))))
                                    ),
                                    this.el
                                );
                            });
