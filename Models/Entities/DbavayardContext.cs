...
public partial class DbavayardContext : DbContext
{
    ...
    public virtual DbSet<TaxTotalCost> TaxTotalCosts { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrderPayment>(entity =>
        {
            ...
            entity.Property(e => e.IsTotalCost).HasColumnName("is_total_cost");
            entity.Property(e => e.IssueType)
                .HasMaxLength(5)
                .IsUnicode(false)
                .HasColumnName("issue_type");
        ...
        modelBuilder.Entity<TaxTotalCost>(entity =>
        {
            entity.ToTable("tax_total_cost");
            ...
            entity.Property(e => e.CreateDate)
                ...
                .HasColumnName("create_date");
            entity.Property(e => e.IsEnabled).HasColumnName("is_enabled");
            entity.Property(e => e.SizeLongCost)
                .HasColumnType("decimal(18, 2)")
                .HasColumnName("size_long_cost");
            entity.Property(e => e.SizeShortCost)
                .HasColumnType("decimal(18, 2)")
                .HasColumnName("size_short_cost");
            entity.Property(e => e.TaxId)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasColumnName("tax_id");

            entity.HasOne(d => d.Tax).WithMany(p => p.TaxTotalCosts)
                .HasForeignKey(d => d.TaxId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_tax_total_cost_tax_address");
        });
